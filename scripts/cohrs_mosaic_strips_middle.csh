...
#+
#  Name:
#     cohrs_mosaic_strips_middle.csh

#  Purpose:
#     Forms mosaics of COHRS middle-longitude tiles
...
#     to form a series of mosaics for the middle longitudes.  Along the
#     way it also ensures that the mosaics are aligned in the LSRK
#     Standard of Rest.
...
#     middle1mosaic.txt would generate a PPV mosaic called middle1mosaic.sdf.
...
#  History:
#     2016 November 23 (MJC):
#        Original version adapted from cohrs_mosaic_strips.csh.
...
foreach f ( `ls -1 $COHRS_FILELISTS/middle*mosaic.txt` )
   echo $f
