...
#+
#  Name:
#     cohrs_mosaic_strips_outer.csh

#  Purpose:
#     Forms mosaics of COHRS outer tiles
...
#     to form a series of mosaics for the outer longitudes.  Along the way
#     it also ensures that the mosaics are aligned in the LSRK Standard
#     of Rest.
...
#     outer2mosaic.txt would generate a PPV mosaic called outer2mosaic.sdf.
...
foreach f ( `ls -1 $COHRS_FILELISTS/outer*mosaic.txt` )
   echo $f
